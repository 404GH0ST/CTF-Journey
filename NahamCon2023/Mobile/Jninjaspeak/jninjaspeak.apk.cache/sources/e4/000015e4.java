...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public void mo1651dispatch(CoroutineContext context, Runnable block) {
    ...
    public void mo1652scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        if (this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, (long) DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.HandlerContext$$ExternalSyntheticLambda0
                ...
                public final void dispose() {
                    HandlerContext.m1600invokeOnTimeout$lambda3(HandlerContext.this, block);
                }
            };
        }
        cancelOnRejection(context, block);
    ...
    public static final void m1600invokeOnTimeout$lambda3(HandlerContext this$0, Runnable $block) {
    ...
    private final void cancelOnRejection(CoroutineContext context, Runnable block) {
        ...
        Dispatchers.getIO().mo1651dispatch(context, block);
    }
